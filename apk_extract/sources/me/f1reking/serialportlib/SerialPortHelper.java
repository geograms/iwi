...
public class SerialPortHelper {
    ...
    public static class Builder {
        public Builder(String str, int i2) {
            ...
            int unused2 = SerialPortHelper.mBaudRate = i2;
        }
        ...
        public Builder setDataBits(int i2) {
            int unused = SerialPortHelper.mDataBits = i2;
            return this;
        }

        public Builder setFlags(int i2) {
            int unused = SerialPortHelper.mFlags = i2;
            return this;
        }

        public Builder setFlowCon(int i2) {
            int unused = SerialPortHelper.mFlowCon = i2;
            return this;
        }

        public Builder setParity(int i2) {
            int unused = SerialPortHelper.mParity = i2;
            return this;
        }

        public Builder setStopBits(int i2) {
            int unused = SerialPortHelper.mStopBits = i2;
            return this;
        }
    }
