...
public class TextAppearance {
    ...
    public TextAppearance(Context context, int i2) throws Resources.NotFoundException {
    ...
    private boolean shouldLoadFontSynchronously(Context context) throws Resources.NotFoundException {
        ...
        if (i2 != 0) {
            ThreadLocal threadLocal = r.f1879a;
            if (!context.isRestricted()) {
                typefaceB = r.b(context, i2, new TypedValue(), 0, null, false, true);
            }
        }
    ...
    public Typeface getFont(Context context) {
        ...
        if (!context.isRestricted()) {
            try {
                Typeface typefaceA = r.a(context, this.fontFamilyResourceId);
                this.font = typefaceA;
                if (typefaceA != null) {
                    this.font = Typeface.create(typefaceA, this.textStyle);
                }
    ...
    public void getFontAsync(Context context, final TextAppearanceFontCallback textAppearanceFontCallback) {
        ...
        try {
            ...
            if (context.isRestricted()) {
                ...
                r.b(context, i2, new TypedValue(), 0, pVar, false, false);
            }
