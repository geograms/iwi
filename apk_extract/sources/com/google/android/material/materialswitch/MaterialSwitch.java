...
public class MaterialSwitch extends SwitchCompat {
    ...
    private static void setInterpolatedDrawableTintIfPossible(Drawable drawable, ColorStateList colorStateList, int[] iArr, int[] iArr2, float f2) {
        ...
        b.g(drawable, d.b(colorStateList.getColorForState(iArr, 0), colorStateList.getColorForState(iArr2, 0), f2));
    }
    ...
    public MaterialSwitch(Context context, AttributeSet attributeSet, int i2) {
        ...
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, R.styleable.MaterialSwitch, i2, i3, new int[0]);
        ...
        int i4 = tintTypedArrayObtainTintedStyledAttributes.getInt(R.styleable.MaterialSwitch_thumbIconTintMode, -1);
