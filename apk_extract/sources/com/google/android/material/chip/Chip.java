...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    public class ChipTouchHelper extends b {
        ...
        @Override // androidx.customview.widget.b
        public void onPopulateNodeForHost(g gVar) {
            gVar.f2507a.setCheckable(Chip.this.isCheckable());
            boolean zIsClickable = Chip.this.isClickable();
            AccessibilityNodeInfo accessibilityNodeInfo = gVar.f2507a;
            accessibilityNodeInfo.setClickable(zIsClickable);
            gVar.f(Chip.this.getAccessibilityClassName());
            accessibilityNodeInfo.setText(Chip.this.getText());
        }

        @Override // androidx.customview.widget.b
        public void onPopulateNodeForVirtualView(int i2, g gVar) {
            if (i2 != 1) {
                gVar.h("");
                gVar.f2507a.setBoundsInParent(Chip.EMPTY_BOUNDS);
                return;
            }
            ...
            if (closeIconContentDescription != null) {
                ...
                gVar.h(context.getString(i3, objArr).trim());
            }
            gVar.f2507a.setBoundsInParent(Chip.this.getCloseIconTouchBoundsInt());
            gVar.b(f.f2494g);
            gVar.f2507a.setEnabled(Chip.this.isEnabled());
        }
    ...
    private void updatePaddingInternal() {
        ...
        WeakHashMap weakHashMap = d1.f138a;
        n0.k(this, iCalculateChipIconWidth, paddingTop, iCalculateCloseIconWidth, paddingBottom);
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (getParent() instanceof ChipGroup) {
            ...
            accessibilityNodeInfo.setCollectionItemInfo((AccessibilityNodeInfo.CollectionItemInfo) c.a.a(chipGroup.getRowIndex(this), 1, chipGroup.isSingleLine() ? chipGroup.getIndexOfChip(this) : -1, 1, false, isChecked()).f1221a);
        }
    }
    ...
    */
    ...
    public Chip(Context context, AttributeSet attributeSet, int i2) {
        ...
        WeakHashMap weakHashMap = d1.f138a;
        chipDrawableCreateFromAttributes.setElevation(s0.i(this));
        ...
        this.lastLayoutDirection = n0.d(this);
        super.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.google.android.material.chip.a
            ...
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z2) {
                this.f1528a.lambda$new$0(compoundButton, z2);
            }
        });
    }
