...
final class MaterialCalendarGridView extends GridView {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Iterator<q.c> it = dateSelector.getSelectedRanges().iterator();
        while (it.hasNext()) {
            q.c next = it.next();
            Object obj = next.f2476a;
            if (obj != null) {
                Object obj2 = next.f2477b;
                if (obj2 != null) {
    ...
    public MaterialCalendarGridView(Context context, AttributeSet attributeSet, int i2) {
        ...
        d1.k(this, new androidx.core.view.c() { // from class: com.google.android.material.datepicker.MaterialCalendarGridView.1
