...
public class RippleUtils {
    ...
    public static class RippleUtilsLollipop {
        ...
        public static Drawable createOvalRipple(Context context, int i2) {
            GradientDrawable gradientDrawable = new GradientDrawable();
            gradientDrawable.setColor(-1);
            gradientDrawable.setShape(1);
            return new RippleDrawable(MaterialColors.getColorStateList(context, com.google.android.material.R.attr.colorControlHighlight, ColorStateList.valueOf(0)), null, new InsetDrawable((Drawable) gradientDrawable, i2, i2, i2, i2));
        }
    }
    ...
    public static Drawable createOvalRippleLollipop(Context context, int i2) {
    ...
    private static int doubleAlpha(int i2) {
        return d.e(i2, Math.min(Color.alpha(i2) * 2, 255));
    }
