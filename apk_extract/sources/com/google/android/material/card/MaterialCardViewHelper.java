...
class MaterialCardViewHelper {
    ...
    public void animateCheckedIcon(boolean z2) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.card.a
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f1527a.lambda$animateCheckedIcon$0(valueAnimator2);
            }
        });
        this.iconAnimator.setInterpolator(this.iconFadeAnimInterpolator);
        this.iconAnimator.setDuration((long) ((z2 ? this.iconFadeInAnimDuration : this.iconFadeOutAnimDuration) * f3));
    ...
    public void recalculateCheckedIconPosition(int i2, int i3) {
        int iCeil;
        int iCeil2;
        int i4;
        int i5;
        if (this.clickableForegroundDrawable != null) {
            ...
            int i6 = isCheckedIconEnd() ? ((i2 - this.checkedIconMargin) - this.checkedIconSize) - iCeil2 : this.checkedIconMargin;
            int i7 = isCheckedIconBottom() ? this.checkedIconMargin : ((i3 - this.checkedIconMargin) - this.checkedIconSize) - iCeil;
            int i8 = isCheckedIconEnd() ? this.checkedIconMargin : ((i2 - this.checkedIconMargin) - this.checkedIconSize) - iCeil2;
            int i9 = isCheckedIconBottom() ? ((i3 - this.checkedIconMargin) - this.checkedIconSize) - iCeil : this.checkedIconMargin;
            ...
            this.clickableForegroundDrawable.setLayerInset(2, i5, i9, i4, i7);
        }
    }
    ...
    public void setCheckedIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            b.h(drawableMutate, this.checkedIconTint);
