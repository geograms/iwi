...
abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    public final boolean fling(CoordinatorLayout coordinatorLayout, V v2, int i2, int i3, float f2) {
    ...
    */
    ...
    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v2, int i2) {
        return setHeaderTopBottomOffset(coordinatorLayout, v2, i2, Integer.MIN_VALUE, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    }
    ...
    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v2, int i2, int i3, int i4) {
        ...
        if (i3 == 0 || topAndBottomOffset < i3 || topAndBottomOffset > i4 || topAndBottomOffset == (iX = g.x(i2, i3, i4))) {
            return 0;
        }
        setTopAndBottomOffset(iX);
        return topAndBottomOffset - iX;
    }
}
