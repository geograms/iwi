...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public void setHourClickDelegate(androidx.core.view.c cVar) {
        d1.k(this.minuteView, cVar);
    }

    public void setMinuteHourDelegate(androidx.core.view.c cVar) {
        d1.k(this.hourView, cVar);
    }
