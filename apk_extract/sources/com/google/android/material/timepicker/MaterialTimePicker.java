...
public final class MaterialTimePicker extends q implements TimePickerView.OnDoubleTapListener {
    ...
    private Pair<Integer, Integer> dataForMode(int i2) {
        ...
        throw new IllegalArgumentException(a.a.c("no icon for mode: ", i2));
    }
    ...
    private TimePickerPresenter initializeOrRetrieveActivePresenterForMode(int i2, TimePickerView timePickerView, ViewStub viewStub) {
        if (i2 != 0) {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        materialShapeDrawable.setElevation(s0.i(decorView));
        return dialog;
    }
