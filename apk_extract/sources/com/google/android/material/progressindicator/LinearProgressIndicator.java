...
public final class LinearProgressIndicator extends BaseProgressIndicator<LinearProgressIndicatorSpec> {
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        boolean z3 = true;
        if (((LinearProgressIndicatorSpec) s2).indicatorDirection != 1) {
            WeakHashMap weakHashMap = d1.f138a;
            if ((n0.d(this) != 1 || ((LinearProgressIndicatorSpec) this.spec).indicatorDirection != 2) && (n0.d(this) != 0 || ((LinearProgressIndicatorSpec) this.spec).indicatorDirection != 3)) {
                z3 = false;
            }
        }
    ...
    public void setIndicatorDirection(int i2) {
        ...
        if (i2 != 1) {
            WeakHashMap weakHashMap = d1.f138a;
            if ((n0.d(this) != 1 || ((LinearProgressIndicatorSpec) this.spec).indicatorDirection != 2) && (n0.d(this) != 0 || i2 != 3)) {
                z2 = false;
            }
        }
