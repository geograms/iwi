...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    public void hide() {
        ...
        if (jUptimeMillis >= i2) {
            ...
            postDelayed(this.delayedHide, i2 - jUptimeMillis);
        }
    }
    ...
    public synchronized void onMeasure(int i2, int i3) {
        try {
            ...
            setMeasuredDimension(currentDrawingDelegate.getPreferredWidth() < 0 ? View.getDefaultSize(getSuggestedMinimumWidth(), i2) : currentDrawingDelegate.getPreferredWidth() + getPaddingLeft() + getPaddingRight(), currentDrawingDelegate.getPreferredHeight() < 0 ? View.getDefaultSize(getSuggestedMinimumHeight(), i3) : currentDrawingDelegate.getPreferredHeight() + getPaddingTop() + getPaddingBottom());
        } catch (Throwable th) {
            throw th;
        }
    }
    ...
    public void setTrackThickness(int i2) {
        S s2 = this.spec;
        if (s2.trackThickness != i2) {
            s2.trackThickness = i2;
            requestLayout();
        }
    }
    ...
    public boolean visibleToUser() {
        ...
        return p0.b(this) && getWindowVisibility() == 0 && isEffectivelyVisible();
    }
