...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f2, float f3, float f4) {
        ...
        int i2 = R.color.design_fab_shadow_start_color;
        Object obj = e.f1841a;
        this.shadowStartColor = d.a(context, i2);
        this.shadowMiddleColor = d.a(context, R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = d.a(context, R.color.design_fab_shadow_end_color);
