...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public static class ActiveIndicatorTransform {
        ...
        public float calculateAlpha(float f2, float f3) {
            return AnimationUtils.lerp(0.0f, 1.0f, f3 == 0.0f ? 0.8f : 0.0f, f3 == 0.0f ? 1.0f : ALPHA_FRACTION, f2);
        }

        public float calculateScaleX(float f2, float f3) {
    ...
    private void refreshItemBackground() {
        ...
        m0.q(this, drawableCreateItemBackgroundCompat);
        setDefaultFocusHighlightEnabled(z2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void setActiveIndicatorProgress(float f2, float f3) {
    ...
    private static void setTextAppearanceWithoutFontScaling(TextView textView, int i2) throws Resources.NotFoundException {
    ...
    private static void setViewScaleValues(View view, float f2, float f3, int i2) {
        view.setScaleX(f2);
        view.setScaleY(f3);
        view.setVisibility(i2);
    }

    private static void setViewTopMarginAndGravity(View view, int i2, int i3) {
    ...
    private static void updateViewPaddingBottom(View view, int i2) {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) throws Resources.NotFoundException {
        ...
        accessibilityNodeInfo.setCollectionItemInfo((AccessibilityNodeInfo.CollectionItemInfo) a.a(0, 1, getItemVisiblePosition(), 1, false, isSelected()).f1221a);
        if (isSelected()) {
            accessibilityNodeInfo.setClickable(false);
            accessibilityNodeInfo.removeAction((AccessibilityNodeInfo.AccessibilityAction) f.f2494g.f2503a);
        }
    ...
    public void setEnabled(boolean z2) {
        ...
        if (!z2) {
            ...
            PointerIcon pointerIconB = g0.b(getContext(), 1002);
            WeakHashMap weakHashMap2 = d1.f138a;
            u0.d(this, pointerIconB);
        }
    }
    ...
    public void setTextAppearanceActive(int i2) throws Resources.NotFoundException {
    ...
    public void setTextAppearanceInactive(int i2) throws Resources.NotFoundException {
