...
public class ShapePath {
    ...
    public static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i2, Canvas canvas) {
            ...
            double dHypot = Math.hypot(this.operation1.f1600x - this.startX, this.operation1.f1601y - this.startY);
            double dHypot2 = Math.hypot(this.operation2.f1600x - this.operation1.f1600x, this.operation2.f1601y - this.operation1.f1601y);
            float fMin = (float) Math.min(i2, Math.min(dHypot, dHypot2));
            double d2 = fMin;
            double dTan = Math.tan(Math.toRadians((-sweepAngle) / 2.0f)) * d2;
            if (dHypot > dTan) {
                ...
                shadowRenderer2.drawEdgeShadow(canvas, this.renderMatrix, rectF, i2);
            } else {
                shadowRenderer2 = shadowRenderer;
            }
            float f2 = 2.0f * fMin;
            ...
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.operation1.f1600x, this.operation1.f1601y);
            this.renderMatrix.preRotate(getStartAngle());
            this.renderMatrix.preTranslate((float) ((-dTan) - d2), (-2.0f) * fMin);
            shadowRenderer.drawInnerCornerShadow(canvas, this.renderMatrix, rectF2, (int) fMin, 450.0f, sweepAngle, new float[]{(float) (d2 + dTan), f2});
            if (dHypot2 > dTan) {
                ...
                shadowRenderer2.drawEdgeShadow(canvas, this.renderMatrix, rectF3, i2);
            }
        }

        public float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation2.f1601y - this.operation1.f1601y) / (this.operation2.f1600x - this.operation1.f1600x)));
        }

        public float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation1.f1601y - this.startY) / (this.operation1.f1600x - this.startX)));
        }
    ...
    public static class LineShadowOperation extends ShadowCompatOperation {
        ...
        @Override // com.google.android.material.shape.ShapePath.ShadowCompatOperation
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i2, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f1601y - this.startY, this.operation.f1600x - this.startX), 0.0f);
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.startX, this.startY);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f1601y - this.startY) / (this.operation.f1600x - this.startX)));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        private float f1600x;

        /* renamed from: y, reason: collision with root package name */
        private float f1601y;
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f1600x, this.f1601y);
            path.transform(matrix);
        }
    }
    ...
    public void lineTo(float f2, float f3) {
        ...
        pathLineOperation.f1600x = f2;
        pathLineOperation.f1601y = f3;
    ...
    public void lineTo(float f2, float f3, float f4, float f5) {
        ...
        pathLineOperation2.f1600x = f4;
        pathLineOperation2.f1601y = f5;
