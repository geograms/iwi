...
public class ExtendedFloatingActionButton extends MaterialButton implements b {
    ...
    public class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues("paddingStart")) {
                ...
                propertyValuesHolder.setFloatValues(n0.f(extendedFloatingActionButton), this.size.getPaddingStart());
            ...
            if (currentMotionSpec.hasPropertyValues("paddingEnd")) {
                ...
                propertyValuesHolder2.setFloatValues(n0.e(extendedFloatingActionButton2), this.size.getPaddingEnd());
    ...
    public static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends c {
        ...
        private boolean shouldUpdateVisibility(View view, ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            if ((this.autoHideEnabled || this.autoShrinkEnabled) && fVar.f81f == view.getId()) {
    ...
    static {
        ...
        PADDING_START = new Property<View, Float>(cls, "paddingStart") { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.8
            ...
            public Float get(View view) {
                WeakHashMap weakHashMap = d1.f138a;
                return Float.valueOf(n0.f(view));
            }
            ...
            public void set(View view, Float f2) {
                ...
                WeakHashMap weakHashMap = d1.f138a;
                n0.k(view, iIntValue, paddingTop, n0.e(view), view.getPaddingBottom());
            }
        };
        PADDING_END = new Property<View, Float>(cls, "paddingEnd") { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.9
            ...
            public Float get(View view) {
                WeakHashMap weakHashMap = d1.f138a;
                return Float.valueOf(n0.e(view));
            }

            @Override // android.util.Property
            public void set(View view, Float f2) {
                WeakHashMap weakHashMap = d1.f138a;
                n0.k(view, n0.f(view), view.getPaddingTop(), f2.intValue(), view.getPaddingBottom());
            }
        };
    }
    ...
    public void performMotion(int i2, final OnChangedCallback onChangedCallback) {
        ...
        if (i2 == 0) {
            ...
            if (i2 != 3) {
                throw new IllegalStateException(a.c("Unknown strategy type: ", i2));
            }
    ...
    private boolean shouldAnimateVisibilityChange() {
        WeakHashMap weakHashMap = d1.f138a;
        return (p0.c(this) || (!isOrWillBeShown() && this.animateShowBeforeLayout)) && !isInEditMode();
    }
    ...
    public void setPadding(int i2, int i3, int i4, int i5) {
        ...
        WeakHashMap weakHashMap = d1.f138a;
        this.extendedPaddingStart = n0.f(this);
        this.extendedPaddingEnd = n0.e(this);
    }
