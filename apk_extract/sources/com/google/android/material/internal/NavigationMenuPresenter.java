...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    public class NavigationMenuAdapter extends v0 {
        ...
        public int adjustItemPositionForA11yDelegate(int i2) {
            ...
            for (int i4 = 0; i4 < i2; i4++) {
                if (NavigationMenuPresenter.this.adapter.getItemViewType(i4) == 2) {
                    i3--;
                }
            }
            return NavigationMenuPresenter.this.headerLayout.getChildCount() == 0 ? i3 - 1 : i3;
        }
        ...
        private void setAccessibilityDelegate(View view, final int i2, final boolean z2) {
            d1.k(view, new c() { // from class: com.google.android.material.internal.NavigationMenuPresenter.NavigationMenuAdapter.1
                @Override // androidx.core.view.c
                public void onInitializeAccessibilityNodeInfo(View view2, g gVar) {
                    super.onInitializeAccessibilityNodeInfo(view2, gVar);
                    gVar.g(c.a.a(NavigationMenuAdapter.this.adjustItemPositionForA11yDelegate(i2), 1, 1, 1, z2, view2.isSelected()));
                }
            });
        }
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i2) {
            ...
            if (itemViewType != 0) {
                if (itemViewType != 1) {
                    if (itemViewType == 2) {
                        ...
                        setAccessibilityDelegate(viewHolder.itemView, i2, true);
                        return;
                    }
                }
            ...
            m0.q(navigationMenuItemView, drawableNewDrawable);
    ...
    public class NavigationMenuViewAccessibilityDelegate extends b2 {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, g gVar) {
            ...
            gVar.getClass();
            gVar.f2507a.setCollectionInfo(collectionInfoObtain);
        }
    }
    ...
    public static abstract class ViewHolder extends z1 {
    ...
    public void dispatchApplyWindowInsets(n2 n2Var) {
        int iD = n2Var.d();
        ...
        NavigationMenuView navigationMenuView = this.menuView;
        navigationMenuView.setPadding(0, navigationMenuView.getPaddingTop(), 0, n2Var.a());
        d1.b(this.headerLayout, n2Var);
    }
