...
class ViewOverlayApi14 implements ViewOverlayImpl {
    ...
    public static class OverlayViewGroup extends ViewGroup {
        ...
        public ViewParent invalidateChildInParentFast(int i2, int i3, Rect rect) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        public void add(View view) {
            ...
            if (view.getParent() instanceof ViewGroup) {
                ...
                if (viewGroup != this.hostView && viewGroup.getParent() != null) {
