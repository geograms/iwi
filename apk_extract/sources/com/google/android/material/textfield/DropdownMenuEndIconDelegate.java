...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public DropdownMenuEndIconDelegate(EndCompoundLayout endCompoundLayout) {
        ...
        this.onEditTextFocusChangeListener = new d(this, i2);
        this.touchExplorationStateChangeListener = new r.d() { // from class: com.google.android.material.textfield.e
            @Override // r.d
            public final void onTouchExplorationStateChanged(boolean z2) {
                this.f1616a.lambda$new$2(z2);
            }
        };
    ...
    private void setUpDropdownShowHideBehavior() {
        this.autoCompleteTextView.setOnTouchListener(new View.OnTouchListener() { // from class: com.google.android.material.textfield.f
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return this.f1617a.lambda$setUpDropdownShowHideBehavior$4(view, motionEvent);
            }
        });
        if (IS_LOLLIPOP) {
            this.autoCompleteTextView.setOnDismissListener(new AutoCompleteTextView.OnDismissListener() { // from class: com.google.android.material.textfield.g
                ...
                public final void onDismiss() {
                    this.f1618a.lambda$setUpDropdownShowHideBehavior$5();
                }
            });
        }
    ...
    public void onInitializeAccessibilityNodeInfo(View view, r.g gVar) {
        ...
        if (gVar.f2507a.isShowingHintText()) {
            gVar.f2507a.setHintText(null);
        }
    }
    ...
    public void onPopulateAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
        ...
        boolean z2 = accessibilityEvent.getEventType() == 32768 && this.isEndIconChecked && !this.autoCompleteTextView.isPopupShowing();
