...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    private void createScrimAnimation(View view, boolean z2, boolean z3, List<Animator> list, List<Animator.AnimatorListener> list2) {
    ...
    public AnimatorSet onCreateExpandedStateChangeAnimation(View view, final View view2, final boolean z2, boolean z3) {
