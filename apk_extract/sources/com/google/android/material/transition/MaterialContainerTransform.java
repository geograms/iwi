...
public final class MaterialContainerTransform extends v {
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f2) {
            ...
            if (f2 > 1.0f || f2 < 0.0f) {
                ...
                float f5 = fArr2[0];
                float f6 = fArr2[1];
                fA = a.a.a(fA, f5, f4, fA);
                fA2 = a.a.a(fA2, f6, f4, fA2);
            }
            float f7 = fA;
            float f8 = fA2;
            Float fValueOf = Float.valueOf(this.progressThresholds.scale.start);
            fValueOf.getClass();
            float fFloatValue = fValueOf.floatValue();
            Float fValueOf2 = Float.valueOf(this.progressThresholds.scale.end);
            fValueOf2.getClass();
            FitModeResult fitModeResultEvaluate = this.fitModeEvaluator.evaluate(f2, fFloatValue, fValueOf2.floatValue(), this.startBounds.width(), this.startBounds.height(), this.endBounds.width(), this.endBounds.height());
            ...
            rectF2.set(f7 - (f10 / 2.0f), f8, (f10 / 2.0f) + f7, fitModeResult.currentEndHeight + f8);
            this.currentStartBoundsMasked.set(this.currentStartBounds);
            this.currentEndBoundsMasked.set(this.currentEndBounds);
            Float fValueOf3 = Float.valueOf(this.progressThresholds.scaleMask.start);
            fValueOf3.getClass();
            float fFloatValue2 = fValueOf3.floatValue();
            Float fValueOf4 = Float.valueOf(this.progressThresholds.scaleMask.end);
            fValueOf4.getClass();
            float fFloatValue3 = fValueOf4.floatValue();
            ...
            float fLerp = TransitionUtils.lerp(0.0f, 1.0f, fFloatValue2, fFloatValue3, f2);
            ...
            Float fValueOf5 = Float.valueOf(this.progressThresholds.fade.start);
            fValueOf5.getClass();
            float fFloatValue4 = fValueOf5.floatValue();
            Float fValueOf6 = Float.valueOf(this.progressThresholds.fade.end);
            fValueOf6.getClass();
            this.fadeModeResult = this.fadeModeEvaluator.evaluate(f2, fFloatValue4, fValueOf6.floatValue(), 0.35f);
        ...
        private TransitionDrawable(n nVar, View view, RectF rectF, ShapeAppearanceModel shapeAppearanceModel, float f2, View view2, RectF rectF2, ShapeAppearanceModel shapeAppearanceModel2, float f3, int i2, int i3, int i4, int i5, boolean z2, boolean z3, FadeModeEvaluator fadeModeEvaluator, FitModeEvaluator fitModeEvaluator, ProgressThresholdsGroup progressThresholdsGroup, boolean z4) {
            ...
            PathMeasure pathMeasure = new PathMeasure(nVar.getPath(motionPathPoint.x, motionPathPoint.y, motionPathPoint2.x, motionPathPoint2.y), false);
    ...
    private ProgressThresholdsGroup buildThresholdsGroup(boolean z2) {
        return getPathMotion() instanceof MaterialArcMotion ? getThresholdsOrDefault(z2, DEFAULT_ENTER_THRESHOLDS_ARC, DEFAULT_RETURN_THRESHOLDS_ARC) : getThresholdsOrDefault(z2, DEFAULT_ENTER_THRESHOLDS, DEFAULT_RETURN_THRESHOLDS);
    }
    ...
    private static void captureValues(c0 c0Var, View view, int i2, ShapeAppearanceModel shapeAppearanceModel) {
        if (i2 != -1) {
            c0Var.f1054b = TransitionUtils.findDescendantOrAncestorById(c0Var.f1054b, i2);
        } else if (view != null) {
            c0Var.f1054b = view;
        } else if (c0Var.f1054b.getTag(com.google.android.material.R.id.mtrl_motion_snapshot_view) instanceof View) {
            View view2 = (View) c0Var.f1054b.getTag(com.google.android.material.R.id.mtrl_motion_snapshot_view);
            c0Var.f1054b.setTag(com.google.android.material.R.id.mtrl_motion_snapshot_view, null);
            c0Var.f1054b = view2;
        }
        View view3 = c0Var.f1054b;
        ...
        map.put(PROP_SHAPE_APPEARANCE, captureShapeAppearance(view3, relativeBounds, shapeAppearanceModel));
    }

    private static float getElevationOrDefault(float f2, View view) {
        if (f2 != ELEVATION_NOT_SET) {
            return f2;
        }
        WeakHashMap weakHashMap = d1.f138a;
        return s0.i(view);
    ...
    @Override // androidx.transition.v
    public Animator createAnimator(ViewGroup viewGroup, c0 c0Var, c0 c0Var2) throws Resources.NotFoundException {
        ...
        if (c0Var != null && c0Var2 != null) {
            ...
            if (rectF != null && shapeAppearanceModel != null) {
                ...
                final View view2 = c0Var.f1054b;
                final View view3 = c0Var2.f1054b;
                ...
                addListener(new TransitionListenerAdapter() { // from class: com.google.android.material.transition.MaterialContainerTransform.2
                    @Override // com.google.android.material.transition.TransitionListenerAdapter, androidx.transition.u
