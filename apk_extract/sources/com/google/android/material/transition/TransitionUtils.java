...
class TransitionUtils {
    ...
    public static void maybeAddTransition(b0 b0Var, v vVar) {
        if (vVar != null) {
            b0Var.e(vVar);
        }
    }

    public static boolean maybeApplyThemeDuration(v vVar, Context context, int i2) {
        int iResolveThemeDuration;
        if (i2 == 0 || vVar.getDuration() != -1 || (iResolveThemeDuration = MotionUtils.resolveThemeDuration(context, i2, -1)) == -1) {
            return false;
        }
        vVar.setDuration(iResolveThemeDuration);
        return true;
    }

    public static boolean maybeApplyThemeInterpolator(v vVar, Context context, int i2, TimeInterpolator timeInterpolator) {
        if (i2 == 0 || vVar.getInterpolator() != null) {
            return false;
        }
        vVar.setInterpolator(MotionUtils.resolveThemeInterpolator(context, i2, timeInterpolator));
        return true;
    }

    public static boolean maybeApplyThemePath(v vVar, Context context, int i2) {
        n nVarResolveThemePath;
        if (i2 == 0 || (nVarResolveThemePath = resolveThemePath(context, i2)) == null) {
            return false;
        }
        vVar.setPathMotion(nVarResolveThemePath);
        return true;
    }

    public static void maybeRemoveTransition(b0 b0Var, v vVar) {
        if (vVar != null) {
            b0Var.f(vVar);
        }
    }

    public static n resolveThemePath(Context context, int i2) {
        ...
        if (i3 != 16) {
            if (i3 == 3) {
                return new o(g.G(String.valueOf(typedValue.string)));
            }
