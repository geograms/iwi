...
public class AppCompatSpinner extends Spinner {
    ...
    public static final class Api17Impl {
        ...
        public static void setTextAlignment(View view, int i2) {
    ...
    public class DialogPopup implements SpinnerPopup, DialogInterface.OnClickListener {
        ...
        public void show(int i2, int i3) {
            ...
            Api17Impl.setTextDirection(listView, i2);
            Api17Impl.setTextAlignment(listView, i3);
            this.mPopup.show();
        }
    }
    ...
    public class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public void computeContentWidth() {
            ...
            setHorizontalOffset(ViewUtils.isLayoutRtl(AppCompatSpinner.this) ? (((width - paddingRight) - getWidth()) - getHorizontalOriginalOffset()) + i2 : paddingLeft + getHorizontalOriginalOffset() + i2);
        }
        ...
        public boolean isVisibleToUser(View view) {
            ...
            return p0.b(view) && view.getGlobalVisibleRect(this.mVisibleRect);
        }
