...
public class AppCompatImageHelper {
    ...
    private boolean applyFrameworkTintUsingColorFilter(Drawable drawable) {
        ...
        tintInfo.clear();
        ColorStateList colorStateListA = f.a(this.mView);
        if (colorStateListA != null) {
            tintInfo.mHasTintList = true;
            tintInfo.mTintList = colorStateListA;
        }
        PorterDuff.Mode modeB = f.b(this.mView);
        if (modeB != null) {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i2) {
        ...
        y0.c(imageView, context, iArr, attributeSet, wrappedTypeArray, i2, 0);
        try {
            Drawable drawable = this.mView.getDrawable();
            ...
            if (tintTypedArrayObtainStyledAttributes.hasValue(R.styleable.AppCompatImageView_tint)) {
                f.c(this.mView, tintTypedArrayObtainStyledAttributes.getColorStateList(R.styleable.AppCompatImageView_tint));
            }
            if (tintTypedArrayObtainStyledAttributes.hasValue(R.styleable.AppCompatImageView_tintMode)) {
                f.d(this.mView, DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(R.styleable.AppCompatImageView_tintMode, -1), null));
            }
