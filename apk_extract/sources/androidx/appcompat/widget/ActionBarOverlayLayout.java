...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, z, a0 {
    ...
    */
    ...
    public WindowInsets onApplyWindowInsets(WindowInsets windowInsets) {
        pullChildren();
        n2 n2VarG = n2.g(this, windowInsets);
        boolean zApplyInsets = applyInsets(this.mActionBarTop, new Rect(n2VarG.b(), n2VarG.d(), n2VarG.c(), n2VarG.a()), true, true, false, true);
        Rect rect = this.mBaseContentInsets;
        WeakHashMap weakHashMap = d1.f138a;
        s0.b(this, n2VarG, rect);
        ...
        n2 n2VarL = l2Var.l(i2, i3, i4, i5);
        this.mBaseInnerInsets = n2VarL;
        if (!this.mLastBaseInnerInsets.equals(n2VarL)) {
        ...
        if (this.mLastBaseContentInsets.equals(this.mBaseContentInsets)) {
            ...
            return l2Var.a().f189a.c().f189a.b().f();
        }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        n2 n2Var = this.mBaseInnerInsets;
        this.mInnerInsets = n2Var;
        if (this.mOverlayMode || z2) {
            f fVarB = f.b(n2Var.b(), this.mInnerInsets.d() + measuredHeight, this.mInnerInsets.c(), this.mInnerInsets.a());
            n2 n2Var2 = this.mInnerInsets;
            f2 e2Var = Build.VERSION.SDK_INT >= 30 ? new e2(n2Var2) : new d2(n2Var2);
            e2Var.f(fVarB);
            this.mInnerInsets = e2Var.b();
        } else {
            Rect rect = this.mContentInsets;
            rect.top += measuredHeight;
            rect.bottom = rect.bottom;
            this.mInnerInsets = n2Var.f189a.l(0, measuredHeight, 0, 0);
        }
        applyInsets(this.mContent, this.mContentInsets, true, true, true, true);
        if (!this.mLastInnerInsets.equals(this.mInnerInsets)) {
            n2 n2Var3 = this.mInnerInsets;
            this.mLastInnerInsets = n2Var3;
            d1.b(this.mContent, n2Var3);
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        n2 n2Var = n2.f188b;
        this.mBaseInnerInsets = n2Var;
        this.mLastBaseInnerInsets = n2Var;
        this.mInnerInsets = n2Var;
        this.mLastInnerInsets = n2Var;
