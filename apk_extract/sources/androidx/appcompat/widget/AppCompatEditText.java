...
public class AppCompatEditText extends EditText implements e0, EmojiCompatConfigurationView {
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        if (inputConnectionOnCreateInputConnection2 != null && Build.VERSION.SDK_INT <= 30 && (strArrE = d1.e(this)) != null) {
            editorInfo.contentMimeTypes = strArrE;
            inputConnectionOnCreateInputConnection2 = new b(inputConnectionOnCreateInputConnection2, new com.google.android.material.search.a(this));
        }
    ...
    public l onReceiveContent(l lVar) {
        return this.mDefaultOnReceiveContentListener.a(this, lVar);
    }

    @Override // android.widget.EditText, android.widget.TextView
    public boolean onTextContextMenuItem(int i2) {
        if (AppCompatReceiveContentHelper.maybeHandleMenuActionViaPerformReceiveContent(this, i2)) {
            return true;
        }
