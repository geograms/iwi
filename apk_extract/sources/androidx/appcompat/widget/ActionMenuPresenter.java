...
class ActionMenuPresenter extends BaseMenuPresenter implements d {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            ...
            i2 = ((i5 % i10) / iMeasureChildForCells) + i10;
        } else {
    ...
    public void updateMenuView(boolean z2) {
        ...
        if (menuBuilder != null) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                f supportActionProvider = actionItems.get(i2).getSupportActionProvider();
