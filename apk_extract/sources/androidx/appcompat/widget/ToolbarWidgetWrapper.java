...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    private void setTitleInt(CharSequence charSequence) {
        ...
        if ((this.mDisplayOpts & 8) != 0) {
            ...
            if (this.mTitleSet) {
                d1.l(this.mToolbar.getRootView(), charSequence);
            }
        }
    }
    ...
    public void animateToVisibility(int i2) {
        View view;
        l1 l1Var = setupAnimatorToVisibility(i2, DEFAULT_FADE_DURATION_MS);
        if (l1Var == null || (view = (View) l1Var.f184a.get()) == null) {
            return;
        }
        view.animate().start();
    }
        ...
        if (i2 != i3) {
            ...
            if (i2 != 0) {
                if (i2 == 1) {
                    ...
                    if (i2 != 2) {
                        throw new IllegalArgumentException(a.a.c("Invalid navigation mode ", i2));
                    }
    ...
    @Override // androidx.appcompat.widget.DecorToolbar
    public l1 setupAnimatorToVisibility(final int i2, long j2) {
        l1 l1VarA = d1.a(this.mToolbar);
        l1VarA.a(i2 == 0 ? 1.0f : 0.0f);
        l1VarA.c(j2);
        l1VarA.d(new n1() { // from class: androidx.appcompat.widget.ToolbarWidgetWrapper.2
