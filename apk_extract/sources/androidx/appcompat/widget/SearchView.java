...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private void updateSearchAutoComplete() {
        ...
        c cVar = this.mSuggestionsAdapter;
        if (cVar != null) {
    ...
    public void setQueryRefinementEnabled(boolean z2) {
        ...
        if (cVar instanceof SuggestionsAdapter) {
            ((SuggestionsAdapter) cVar).setQueryRefinement(z2 ? 2 : 1);
        }
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.mReleaseCursorRunnable = new Runnable() { // from class: androidx.appcompat.widget.SearchView.2
            @Override // java.lang.Runnable
            public void run() {
                c cVar = SearchView.this.mSuggestionsAdapter;
                if (cVar instanceof SuggestionsAdapter) {
                    cVar.changeCursor(null);
                }
            }
        ...
        m0.q(viewFindViewById, tintTypedArrayObtainStyledAttributes.getDrawable(R.styleable.SearchView_queryBackground));
        m0.q(viewFindViewById2, tintTypedArrayObtainStyledAttributes.getDrawable(R.styleable.SearchView_submitBackground));
