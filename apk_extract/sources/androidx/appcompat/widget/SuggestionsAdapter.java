...
import androidx.cursoradapter.widget.f;
import i.c;
import i.e;
...
class SuggestionsAdapter extends f implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) throws PackageManager.NameNotFoundException {
        ...
        try {
            ActivityInfo activityInfo = packageManager.getActivityInfo(componentName, Optimizer.OPTIMIZATION_GRAPH_WRAP);
    ...
    private Drawable getDrawableFromResourceValue(String str) throws NumberFormatException, IOException {
        ...
        try {
            ...
            Object obj = e.f1841a;
            Drawable drawableB = c.b(context, i2);
            storeInIconCache(str2, drawableB);
            return drawableB;
        } catch (Resources.NotFoundException unused) {
    ...
    public View getDropDownView(int i2, View view, ViewGroup viewGroup) {
        try {
            ...
            View viewNewDropDownView = this.newDropDownView(this.mProviderContext, this.getCursor(), viewGroup);
    ...
    public View getView(int i2, View view, ViewGroup viewGroup) {
        try {
            ...
            Log.w(LOG_TAG, "Search suggestions cursor threw exception.", e2);
            View viewNewView = this.newView(this.mProviderContext, this.getCursor(), viewGroup);
            if (viewNewView != null) {
