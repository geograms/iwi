...
public class Toolbar extends ViewGroup {
    ...
    private void addCustomViewsWithGravity(List<View> list, int i2) {
        ...
        int absoluteGravity = Gravity.getAbsoluteGravity(i2, n0.d(this));
        list.clear();
        if (!z2) {
    ...
    private int getViewListMeasuredWidth(List<View> list, int[] iArr) {
        ...
        while (i4 < size) {
            ...
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            int i5 = ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin - i2;
    ...
    private void onCreateMenu() {
        ...
        Iterator it2 = this.mMenuHostHelper.f212b.iterator();
        if (it2.hasNext()) {
            a.a.j(it2.next());
            throw null;
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:108:0x02a5 A[LOOP:0: B:107:0x02a3->B:108:0x02a5, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:111:0x02c7 A[LOOP:1: B:110:0x02c5->B:111:0x02c7, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:115:0x02f1  */
    /* JADX WARN: Removed duplicated region for block: B:120:0x0300 A[LOOP:2: B:119:0x02fe->B:120:0x0300, LOOP_END] */
    ...
    */
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (shouldLayout(this.mTitleTextView)) {
            measureChildCollapseMargins(this.mTitleTextView, i2, iMax4 + i7, i3, i6, iArr);
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            iMax2 = Math.max(iMax2, measureChildCollapseMargins(this.mSubtitleTextView, i2, iMax4 + i7, i3, measuredHeight + i6, iArr));
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (i2 != 0 && this.mExpandedMenuPresenter != null && menuBuilderPeekMenu != null && (menuItemFindItem = menuBuilderPeekMenu.findItem(i2)) != null) {
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.mMenuHostHelper = new u(new a(2, this));
        ...
        this.mMenuViewItemClickListener = new ActionMenuView.OnMenuItemClickListener() { // from class: androidx.appcompat.widget.Toolbar.1
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                Iterator it = Toolbar.this.mMenuHostHelper.f212b.iterator();
                if (it.hasNext()) {
                    a.a.j(it.next());
                    throw null;
                }
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, R.styleable.Toolbar, i2, 0);
        int[] iArr = R.styleable.Toolbar;
        TypedArray wrappedTypeArray = tintTypedArrayObtainStyledAttributes.getWrappedTypeArray();
        WeakHashMap weakHashMap = d1.f138a;
        y0.c(this, context, iArr, attributeSet, wrappedTypeArray, i2, 0);
