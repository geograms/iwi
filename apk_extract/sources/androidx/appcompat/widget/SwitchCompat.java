...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    public static class EmojiCompatInitCallback extends h {
    ...
    private void animateThumbToCheckedState(boolean z2) {
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this, THUMB_POS, z2 ? 1.0f : 0.0f);
        ...
        if (drawable != null) {
            if (this.mHasThumbTint || this.mHasThumbTintMode) {
                ...
                if (this.mHasThumbTint) {
                    b.h(drawableMutate, this.mThumbTintList);
                }
                if (this.mHasThumbTintMode) {
                    b.i(this.mThumbDrawable, this.mThumbTintMode);
                }
        ...
        if (drawable != null) {
            if (this.mHasTrackTint || this.mHasTrackTintMode) {
                ...
                if (this.mHasTrackTint) {
                    b.h(drawableMutate, this.mTrackTintList);
                }
                if (this.mHasTrackTintMode) {
                    b.i(this.mTrackDrawable, this.mTrackTintMode);
                }
    ...
    private void setOffStateDescriptionOnRAndAbove() throws Resources.NotFoundException {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            new i0(R$id.tag_state_description, 64, 30, 2).b(this, string);
        }
    }
    ...
    private void setupEmojiCompatLoadCallback() {
        if (this.mEmojiCompatInitCallback == null && this.mAppCompatEmojiTextHelper.isEnabled() && j.f373j != null) {
            j jVarA = j.a();
            int iB = jVarA.b();
            if (iB == 3 || iB == 0) {
                EmojiCompatInitCallback emojiCompatInitCallback = new EmojiCompatInitCallback(this);
                this.mEmojiCompatInitCallback = emojiCompatInitCallback;
                jVarA.g(emojiCompatInitCallback);
            }
        }
    }
    ...
    */
    ...
    public void setSwitchTextAppearance(Context context, int i2) {
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, i2, androidx.appcompat.R.styleable.TextAppearance);
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i2) throws Resources.NotFoundException {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, androidx.appcompat.R.styleable.SwitchCompat, i2, 0);
