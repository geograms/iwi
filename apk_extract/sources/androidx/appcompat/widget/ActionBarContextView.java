...
public class ActionBarContextView extends AbsActionBarView {
    ...
    private void initTitle() {
        ...
        this.mTitleLayout.setVisibility((z2 || z3) ? 0 : 8);
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        int i8 = iPositionChild;
        View view2 = this.mCustomView;
        if (view2 != null) {
            positionChild(view2, i8, paddingTop, paddingTop2, zIsLayoutRtl);
        }
    ...
    @Override // androidx.appcompat.widget.AbsActionBarView
    public /* bridge */ /* synthetic */ l1 setupAnimatorToVisibility(int i2, long j2) {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i2) {
        ...
        Drawable drawable = tintTypedArrayObtainStyledAttributes.getDrawable(R.styleable.ActionMode_background);
        WeakHashMap weakHashMap = d1.f138a;
        m0.q(this, drawable);
