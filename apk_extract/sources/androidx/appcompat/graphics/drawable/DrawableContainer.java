...
class DrawableContainer extends Drawable implements Drawable.Callback {
    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        private Drawable prepareDrawable(Drawable drawable) {
            c.b(drawable, this.mLayoutDirection);
    ...
    private void initializeDrawableForDisplay(Drawable drawable) {
        ...
        try {
            ...
            a.e(drawable, this.mDrawableContainerState.mAutoMirrored);
    ...
    public static int resolveDensity(Resources resources, int i2) {
        if (resources != null) {
    ...
    */
    ...
    public void setTintList(ColorStateList colorStateList) {
        ...
        if (drawableContainerState.mTintList != colorStateList) {
            ...
            b.h(this.mCurrDrawable, colorStateList);
        }
    }
