...
public class SupportActionModeWrapper extends android.view.ActionMode {
    ...
    public static class CallbackWrapper implements ActionMode.Callback {
        ...
        private Menu getMenuWrapper(Menu menu) {
            Menu menu2 = (Menu) this.mMenus.getOrDefault(menu, null);
            if (menu2 != null) {
                return menu2;
            }
            MenuWrapperICS menuWrapperICS = new MenuWrapperICS(this.mContext, (a) menu);
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.mWrappedCallback.onActionItemClicked(getActionModeWrapper(actionMode), new MenuItemWrapperICS(this.mContext, (b) menuItem));
        }
    ...
    @Override // android.view.ActionMode
    public Menu getMenu() {
        return new MenuWrapperICS(this.mContext, (a) this.mWrappedObject.getMenu());
    }
