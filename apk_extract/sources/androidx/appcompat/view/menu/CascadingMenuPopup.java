...
final class CascadingMenuPopup extends MenuPopup implements View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private void showMenu(MenuBuilder menuBuilder) {
        ...
        if (viewFindParentViewForSubmenu != null) {
            ...
            if ((this.mDropDownGravity & 5) != 5) {
                iMeasureIndividualMenuWidth = z2 ? viewFindParentViewForSubmenu.getWidth() : 0 - iMeasureIndividualMenuWidth;
            } else if (!z2) {
    ...
    public void setAnchorView(View view) {
        if (this.mAnchorView != view) {
            ...
            WeakHashMap weakHashMap = d1.f138a;
            this.mDropDownGravity = Gravity.getAbsoluteGravity(i2, n0.d(view));
        }
    }
