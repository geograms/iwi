...
public final class MenuItemImpl implements b {
    ...
    private int mShortcutNumericModifiers = MotionScene.Transition.TransitionOnClick.JUMP_TO_START;
    private int mShortcutAlphabeticModifiers = MotionScene.Transition.TransitionOnClick.JUMP_TO_START;
    ...
    private Drawable applyIconTintIfNecessary(Drawable drawable) {
        if (drawable != null && this.mNeedToApplyIconTint && (this.mHasIconTint || this.mHasIconTintMode)) {
            ...
            if (this.mHasIconTint) {
                l.b.h(drawable, this.mIconTintList);
            }
            if (this.mHasIconTintMode) {
                l.b.i(drawable, this.mIconTintMode);
            }
    ...
    public View getActionView() {
        ...
        f fVar = this.mActionProvider;
        if (fVar == null) {
            return null;
        }
        View viewOnCreateActionView = fVar.onCreateActionView(this);
    ...
    public String getShortcutLabel() {
        ...
        appendModifier(sb, i2, MotionScene.Transition.TransitionOnClick.JUMP_TO_START, resources.getString(R.string.abc_menu_ctrl_shortcut_label));
    ...
    @Override // m.b
    public f getSupportActionProvider() {
    ...
    public boolean hasCollapsibleActionView() {
        ...
        if (this.mActionView == null && (fVar = this.mActionProvider) != null) {
            this.mActionView = fVar.onCreateActionView(this);
        }
    ...
    public boolean isVisible() {
        f fVar = this.mActionProvider;
        return (fVar == null || !fVar.overridesItemVisibility()) ? (this.mFlags & 8) == 0 : (this.mFlags & 8) == 0 && this.mActionProvider.isVisible();
    }
    ...
    public void setCheckedInt(boolean z2) {
        int i2 = this.mFlags;
        int i3 = (z2 ? 2 : 0) | (i2 & (-3));
        this.mFlags = i3;
        if (i2 != i3) {
    ...
    @Override // m.b
    public b setSupportActionProvider(f fVar) {
        f fVar2 = this.mActionProvider;
        if (fVar2 != null) {
            fVar2.reset();
        }
        this.mActionView = null;
        this.mActionProvider = fVar;
        this.mMenu.onItemsChanged(true);
        f fVar3 = this.mActionProvider;
        if (fVar3 != null) {
            fVar3.setVisibilityListener(new e() { // from class: androidx.appcompat.view.menu.MenuItemImpl.1
    ...
    public boolean setVisibleInt(boolean z2) {
        int i2 = this.mFlags;
        int i3 = (z2 ? 0 : 8) | (i2 & (-9));
        this.mFlags = i3;
        return i2 != i3;
