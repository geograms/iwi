...
public class MenuItemWrapperICS extends BaseMenuWrapper implements MenuItem {
    ...
    private final b mWrappedObject;

    public class ActionProviderWrapper extends f {
    ...
    public MenuItemWrapperICS(Context context, b bVar) {
        super(context);
        if (bVar == null) {
    ...
    public ActionProvider getActionProvider() {
        f supportActionProvider = this.mWrappedObject.getSupportActionProvider();
    ...
    public MenuItem setActionProvider(ActionProvider actionProvider) {
        ...
        b bVar = this.mWrappedObject;
        if (actionProvider == null) {
            actionProviderWrapperJB = null;
        }
        bVar.setSupportActionProvider(actionProviderWrapperJB);
        return this;
    }
