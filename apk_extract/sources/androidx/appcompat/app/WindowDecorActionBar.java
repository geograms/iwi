...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    final m1 mHideListener = new n1() { // from class: androidx.appcompat.app.WindowDecorActionBar.1
    ...
    final m1 mShowListener = new n1() { // from class: androidx.appcompat.app.WindowDecorActionBar.2
        @Override // androidx.core.view.m1
        public void onAnimationEnd(View view) {
            WindowDecorActionBar windowDecorActionBar = WindowDecorActionBar.this;
    ...
    final o1 mUpdateListener = new o1() { // from class: androidx.appcompat.app.WindowDecorActionBar.3
    ...
    public void animateToMode(boolean z2) {
        ...
        if (z2) {
            l1Var = this.mDecorToolbar.setupAnimatorToVisibility(4, FADE_OUT_DURATION_MS);
            l1Var2 = this.mContextView.setupAnimatorToVisibility(0, FADE_IN_DURATION_MS);
        } else {
            l1 l1Var3 = this.mDecorToolbar.setupAnimatorToVisibility(0, FADE_IN_DURATION_MS);
            l1Var = this.mContextView.setupAnimatorToVisibility(8, FADE_OUT_DURATION_MS);
            l1Var2 = l1Var3;
        }
        ViewPropertyAnimatorCompatSet viewPropertyAnimatorCompatSet = new ViewPropertyAnimatorCompatSet();
        viewPropertyAnimatorCompatSet.playSequentially(l1Var, l1Var2);
    ...
    public void doHide(boolean z2) {
        ...
        l1 l1VarA = d1.a(this.mContainerView);
        l1VarA.e(f2);
        o1 o1Var = this.mUpdateListener;
        View view2 = (View) l1VarA.f184a.get();
        if (view2 != null) {
            k1.a(view2.animate(), o1Var != null ? new i1(0, o1Var, view2) : null);
        }
        viewPropertyAnimatorCompatSet2.play(l1VarA);
        if (this.mContentAnimations && (view = this.mContentView) != null) {
            l1 l1VarA2 = d1.a(view);
            l1VarA2.e(f2);
            viewPropertyAnimatorCompatSet2.play(l1VarA2);
        }
    ...
    public void doShow(boolean z2) {
        ...
        if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || z2)) {
            ...
            l1VarA.e(0.0f);
            o1 o1Var = this.mUpdateListener;
            View view3 = (View) l1VarA.f184a.get();
            if (view3 != null) {
                k1.a(view3.animate(), o1Var != null ? new i1(0, o1Var, view3) : null);
            }
            viewPropertyAnimatorCompatSet2.play(l1VarA);
            if (this.mContentAnimations && (view2 = this.mContentView) != null) {
                view2.setTranslationY(f2);
                l1 l1VarA2 = d1.a(this.mContentView);
                l1VarA2.e(0.0f);
                viewPropertyAnimatorCompatSet2.play(l1VarA2);
            }
    ...
    public void selectTab(ActionBar.Tab tab) {
        ...
        if (!(this.mActivity instanceof c0) || this.mDecorToolbar.getViewGroup().isInEditMode()) {
            aVar = null;
        } else {
            w0 supportFragmentManager = ((c0) this.mActivity).getSupportFragmentManager();
        ...
        if (aVar == null || aVar.f523a.isEmpty()) {
            return;
        }
        aVar.e(false);
    }
