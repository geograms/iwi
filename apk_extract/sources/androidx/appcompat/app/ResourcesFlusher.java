...
class ResourcesFlusher {
    ...
    private static void flushLollipops(Resources resources) throws NoSuchFieldException, SecurityException {
        Map map;
    ...
    private static void flushMarshmallows(Resources resources) throws IllegalAccessException, NoSuchFieldException, SecurityException, IllegalArgumentException {
        Object obj;
        if (!sDrawableCacheFieldFetched) {
            try {
                Field declaredField = Resources.class.getDeclaredField("mDrawableCache");
    ...
    private static void flushNougats(Resources resources) throws IllegalAccessException, NoSuchFieldException, SecurityException, IllegalArgumentException {
        Object obj;
    ...
    private static void flushThemedResourcesCache(Object obj) throws NoSuchFieldException, SecurityException {
