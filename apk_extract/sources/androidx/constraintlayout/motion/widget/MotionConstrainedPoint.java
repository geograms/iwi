...
class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    public void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f66x, this.f67y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        int i2 = 0;
        for (int i3 : iArr) {
            if (i3 < 18) {
                dArr[i2] = fArr[r2];
    ...
    public void different(MotionConstrainedPoint motionConstrainedPoint, boolean[] zArr, String[] strArr) {
        ...
        zArr[1] = zArr[1] | diff(this.f66x, motionConstrainedPoint.f66x);
        zArr[2] = zArr[2] | diff(this.f67y, motionConstrainedPoint.f67y);
