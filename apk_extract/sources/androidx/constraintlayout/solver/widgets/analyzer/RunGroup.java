...
class RunGroup {
    ...
    public long computeWrapSize(ConstraintWidgetContainer constraintWidgetContainer, int i2) {
        ...
        if (zContains && zContains2) {
            ...
            long jA = ((long) ((f2 * biasPercent) + 0.5f)) + wrapDimension2 + ((long) a.a(1.0f, biasPercent, f2, 0.5f));
            wrapDimension = r11.start.margin + jA;
            ...
            wrapDimension = this.firstRun.getWrapDimension() + r12.start.margin;
            i3 = this.firstRun.end.margin;
        }
