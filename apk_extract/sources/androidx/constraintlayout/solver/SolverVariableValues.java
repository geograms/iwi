...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    public String toString() {
        String strD;
        String strD2;
        String strD3 = hashCode() + " { ";
        int i2 = this.mCount;
        for (int i3 = 0; i3 < i2; i3++) {
            SolverVariable variable = getVariable(i3);
            if (variable != null) {
                String str = strD3 + variable + " = " + getVariableValue(i3) + " ";
                int iIndexOf = indexOf(variable);
                String strD4 = a.d(str, "[p: ");
                if (this.previous[iIndexOf] != -1) {
                    StringBuilder sbF = a.f(strD4);
                    sbF.append(this.mCache.mIndexedVariables[this.variables[this.previous[iIndexOf]]]);
                    strD = sbF.toString();
                } else {
                    strD = a.d(strD4, "none");
                }
                String strD5 = a.d(strD, ", n: ");
                if (this.next[iIndexOf] != -1) {
                    StringBuilder sbF2 = a.f(strD5);
                    sbF2.append(this.mCache.mIndexedVariables[this.variables[this.next[iIndexOf]]]);
                    strD2 = sbF2.toString();
                } else {
                    strD2 = a.d(strD5, "none");
                }
                strD3 = a.d(strD2, "]");
            }
        }
