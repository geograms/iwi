...
public class LinearSystem {
    ...
    private void displayRows() {
        ...
        String strD = "";
        for (int i2 = 0; i2 < this.mNumRows; i2++) {
            StringBuilder sbF = a.f(strD);
            sbF.append(this.mRows[i2]);
            strD = a.d(sbF.toString(), "\n");
        }
        StringBuilder sbF2 = a.f(strD);
        sbF2.append(this.mGoal);
        sbF2.append("\n");
    ...
    private String getDisplaySize(int i2) {
        int i3 = i2 * 4;
        int i4 = i3 / Optimizer.OPTIMIZATION_GROUPING;
        int i5 = i4 / Optimizer.OPTIMIZATION_GROUPING;
        if (i5 > 0) {
            return "" + i5 + " Mb";
        }
        if (i4 > 0) {
    ...
    public void displayReadableRows() {
        ...
        for (int i3 = 0; i3 < this.mVariablesID + 1; i3++) {
            ...
            if (solverVariable2 != null && solverVariable2.isSynonym) {
                strD = strD + " ~[" + i3 + "] => " + solverVariable2 + " = " + solverVariableArr[solverVariable2.synonym] + " + " + solverVariable2.synonymDelta + "\n";
            }
        }
        String strD2 = a.d(strD, "\n\n #  ");
        for (int i4 = 0; i4 < this.mNumRows; i4++) {
            StringBuilder sbF = a.f(strD2);
            sbF.append(this.mRows[i4].toReadableString());
            strD2 = a.d(sbF.toString(), "\n #  ");
        }
        if (this.mGoal != null) {
            StringBuilder sbG = a.g(strD2, "Goal: ");
            sbG.append(this.mGoal);
            sbG.append("\n");
            strD2 = sbG.toString();
        }
    ...
    public void displayVariablesReadableRows() {
        ...
        for (int i2 = 0; i2 < this.mNumRows; i2++) {
            if (this.mRows[i2].variable.mType == SolverVariable.Type.UNRESTRICTED) {
                StringBuilder sbF = a.f(strD);
                sbF.append(this.mRows[i2].toReadableString());
                strD = a.d(sbF.toString(), "\n");
            }
        }
        StringBuilder sbF2 = a.f(strD);
