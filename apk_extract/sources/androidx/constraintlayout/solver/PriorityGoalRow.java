...
public class PriorityGoalRow extends ArrayRow {
    ...
    public class GoalVariableAccessor implements Comparable {
        ...
        public String toString() {
            ...
            if (this.variable != null) {
                for (int i2 = 0; i2 < 9; i2++) {
                    StringBuilder sbF = a.f(string);
                    sbF.append(this.variable.goalStrengthVector[i2]);
                    sbF.append(" ");
                    string = sbF.toString();
                }
            }
            StringBuilder sbG = a.g(string, "] ");
            sbG.append(this.variable);
            return sbG.toString();
        }
    }
    ...
    public PriorityGoalRow(Cache cache) {
        super(cache);
        this.TABLE_SIZE = Optimizer.OPTIMIZATION_GRAPH_WRAP;
        this.arrayGoals = new SolverVariable[Optimizer.OPTIMIZATION_GRAPH_WRAP];
        this.sortArray = new SolverVariable[Optimizer.OPTIMIZATION_GRAPH_WRAP];
        this.numGoals = 0;
    ...
    */
    public androidx.constraintlayout.solver.SolverVariable getPivotCandidate(androidx.constraintlayout.solver.LinearSystem r5, boolean[] r6) {
        ...
        L32:
            ...
            return r4
        L36:
            androidx.constraintlayout.solver.SolverVariable[] r4 = r4.arrayGoals
            r4 = r4[r1]
            return r4
        */
