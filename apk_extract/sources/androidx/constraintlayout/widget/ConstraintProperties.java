        ...
        switch (i2) {
            case 1:
                if (i4 == 1) {
                    ...
                    if (i4 != 2) {
                        throw new IllegalArgumentException(a.e(new StringBuilder("Left to "), sideToString(i4), " undefined"));
                    }
            ...
            case 2:
                if (i4 == 1) {
                    ...
                    if (i4 != 2) {
                        throw new IllegalArgumentException(a.e(new StringBuilder("right to "), sideToString(i4), " undefined"));
                    }
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(a.e(sb, sideToString(i4), " unknown"));
        }
    }
