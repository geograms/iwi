...
public class ConstraintLayout extends ViewGroup {
    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            if (i8 == 1) {
                ...
                iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, constraintWidget.getHorizontalMargin() + i7, -1);
            } else if (i8 != 4) {
                iMakeMeasureSpec = 0;
            } else {
                iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i7, -2);
            ...
            if (i10 == 1) {
                iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(i5, BasicMeasure.EXACTLY);
            } else if (i10 == 2) {
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i6, -2);
            } else if (i10 == 3) {
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, constraintWidget.getVerticalMargin() + i6, -1);
            } else if (i10 != 4) {
                iMakeMeasureSpec2 = 0;
            } else {
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i6, -2);
            ...
            if (i12 != BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS && i12 != BasicMeasure.Measure.USE_GIVEN_DIMENSIONS && z6 && constraintWidget.mMatchConstraintDefaultWidth == 0 && z7 && constraintWidget.mMatchConstraintDefaultHeight == 0) {
                ...
                if (measuredWidth != iMax || measuredHeight2 != measuredHeight) {
                    int iMakeMeasureSpec3 = measuredWidth != iMax ? View.MeasureSpec.makeMeasureSpec(iMax, BasicMeasure.EXACTLY) : i2;
                    if (measuredHeight2 != measuredHeight) {
                        iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(measuredHeight, BasicMeasure.EXACTLY);
                    }
            ...
            boolean z12 = baseline != i3 ? ConstraintLayout.USE_CONSTRAINTS_HELPER : false;
            measure.measuredNeedsSolverPass = (iMax == measure.horizontalDimension && measuredHeight == measure.verticalDimension) ? false : ConstraintLayout.USE_CONSTRAINTS_HELPER;
        ...
        if (i11 != -1) {
            ...
            if (i16 != -1) {
                ...
                if (constraintWidget11 != null && view2 != null && (view2.getLayoutParams() instanceof LayoutParams)) {
                    ...
                    constraintWidget.getAnchor(type5).connect(constraintWidget11.getAnchor(type5), 0, -1, USE_CONSTRAINTS_HELPER);
    ...
    public void resolveMeasuredDimension(int i2, int i3, int i4, int i5, boolean z2, boolean z3) {
        ...
        int iResolveSizeAndState = View.resolveSizeAndState(i4 + measurer.paddingWidth, i2, 0);
        int iResolveSizeAndState2 = View.resolveSizeAndState(i5 + i6, i3, 0) & 16777215;
    ...
    public void resolveSystem(ConstraintWidgetContainer constraintWidgetContainer, int i2, int i3, int i4) {
        ...
        this.mMeasurer.captureLayoutInfos(i3, i4, iMax, iMax2, paddingWidth, i5);
        ...
        constraintWidgetContainer.measure(i2, mode, i6, mode2, i7, this.mLastMeasureWidth, this.mLastMeasureHeight, iMax4, iMax);
    }
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) throws NumberFormatException {
            ...
            for (int i3 = 0; i3 < indexCount; i3++) {
                ...
                switch (i4) {
                    ...
                    case Table.LAYOUT_CONSTRAINT_LEFT_TO_RIGHT_OF /* 9 */:
                    ...
                    case Table.LAYOUT_CONSTRAINT_RIGHT_TO_RIGHT_OF /* 11 */:
                    ...
                    case Table.LAYOUT_CONSTRAINT_TOP_TO_TOP_OF /* 12 */:
                    ...
                    case Table.LAYOUT_CONSTRAINT_TOP_TO_BOTTOM_OF /* 13 */:
                    ...
                    case Table.LAYOUT_CONSTRAINT_BOTTOM_TO_TOP_OF /* 14 */:
                    ...
                    case Table.LAYOUT_CONSTRAINT_START_TO_START_OF /* 18 */:
                    ...
                    case Table.LAYOUT_CONSTRAINT_END_TO_START_OF /* 19 */:
                    ...
                    case Table.LAYOUT_CONSTRAINT_WIDTH_MIN /* 33 */:
                        try {
                    ...
                    case Table.LAYOUT_CONSTRAINT_WIDTH_MAX /* 34 */:
                        try {
                    ...
                    case Table.LAYOUT_CONSTRAINT_WIDTH_PERCENT /* 35 */:
                        ...
                        break;
                    case Table.LAYOUT_CONSTRAINT_HEIGHT_MIN /* 36 */:
                        try {
                    ...
                    case Table.LAYOUT_CONSTRAINT_HEIGHT_MAX /* 37 */:
                        try {
                    ...
                    case Table.LAYOUT_CONSTRAINT_HEIGHT_PERCENT /* 38 */:
                    ...
                    default:
                        switch (i4) {
                            case Table.LAYOUT_CONSTRAINT_DIMENSION_RATIO /* 44 */:
